...
int main(int argc, char** argv)
{
  ...
  try{
    ...
    matrix_construction = std::shared_ptr<V_Matrix_Construction> (new Matrix_Construction_Exact(fem_quadrature, materials) );
    ...
    expected_dimensionless_mass[0][0] = 0.26666667 ; 
    expected_dimensionless_mass[0][1] = 0.13333333 ; 
    expected_dimensionless_mass[0][2] = -0.06666667 ; 
    expected_dimensionless_mass[1][0] = 0.13333333 ; 
    expected_dimensionless_mass[1][1] = 1.06666667 ; 
    expected_dimensionless_mass[1][2] = 0.13333333 ; 
    expected_dimensionless_mass[2][0] = -0.06666667 ; 
    expected_dimensionless_mass[2][1] = 0.13333333 ; 
    expected_dimensionless_mass[2][2] = 0.26666667 ; 
    expected_L_mu_positive[0][0] = 0.50000000 ; 
    expected_L_mu_positive[0][1] = 0.66666667 ; 
    expected_L_mu_positive[0][2] = -0.16666667 ; 
    expected_L_mu_positive[1][0] = -0.66666667 ; 
    expected_L_mu_positive[1][1] = 0.00000000 ; 
    expected_L_mu_positive[1][2] = 0.66666667 ; 
    expected_L_mu_positive[2][0] = 0.16666667 ; 
    expected_L_mu_positive[2][1] = -0.66666667 ; 
    expected_L_mu_positive[2][2] = 0.50000000 ; 
    expected_L_mu_negative[0][0] = -0.50000000 ; 
    expected_L_mu_negative[0][1] = 0.66666667 ; 
    expected_L_mu_negative[0][2] = -0.16666667 ; 
    expected_L_mu_negative[1][0] = -0.66666667 ; 
    expected_L_mu_negative[1][1] = 0.00000000 ; 
    expected_L_mu_negative[1][2] = 0.66666667 ; 
    expected_L_mu_negative[2][0] = 0.16666667 ; 
    expected_L_mu_negative[2][1] = -0.66666667 ; 
    expected_L_mu_negative[2][2] = -0.50000000 ; 
    ...
    expected_f_mu_negative[2] = -1.00000000 ; 
