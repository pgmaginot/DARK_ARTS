...
int main(int argc, char** argv)
{
  ...
  try{
    ...
    matrix_construction = std::shared_ptr<V_Matrix_Construction> (new Matrix_Construction_Trad_Lumping(fem_quadrature, materials) );
    ...
    expected_dimensionless_mass[0][0] = 0.25000000 ; 
    ...
    expected_dimensionless_mass[1][1] = 0.75000000 ; 
    ...
    expected_dimensionless_mass[2][2] = 0.75000000 ; 
    ...
    expected_dimensionless_mass[3][3] = 0.25000000 ; 
    expected_L_mu_positive[0][0] = 0.50000000 ; 
    expected_L_mu_positive[0][1] = 0.71250000 ; 
    expected_L_mu_positive[0][2] = -0.30000000 ; 
    expected_L_mu_positive[0][3] = 0.08750000 ; 
    expected_L_mu_positive[1][0] = -0.71250000 ; 
    expected_L_mu_positive[1][1] = -0.00000000 ; 
    expected_L_mu_positive[1][2] = 1.01250000 ; 
    expected_L_mu_positive[1][3] = -0.30000000 ; 
    expected_L_mu_positive[2][0] = 0.30000000 ; 
    expected_L_mu_positive[2][1] = -1.01250000 ; 
    expected_L_mu_positive[2][2] = -0.00000000 ; 
    expected_L_mu_positive[2][3] = 0.71250000 ; 
    expected_L_mu_positive[3][0] = -0.08750000 ; 
    expected_L_mu_positive[3][1] = 0.30000000 ; 
    expected_L_mu_positive[3][2] = -0.71250000 ; 
    expected_L_mu_positive[3][3] = 0.50000000 ; 
    expected_L_mu_negative[0][0] = -0.50000000 ; 
    expected_L_mu_negative[0][1] = 0.71250000 ; 
    expected_L_mu_negative[0][2] = -0.30000000 ; 
    expected_L_mu_negative[0][3] = 0.08750000 ; 
    expected_L_mu_negative[1][0] = -0.71250000 ; 
    expected_L_mu_negative[1][1] = -0.00000000 ; 
    expected_L_mu_negative[1][2] = 1.01250000 ; 
    expected_L_mu_negative[1][3] = -0.30000000 ; 
    expected_L_mu_negative[2][0] = 0.30000000 ; 
    expected_L_mu_negative[2][1] = -1.01250000 ; 
    expected_L_mu_negative[2][2] = -0.00000000 ; 
    expected_L_mu_negative[2][3] = 0.71250000 ; 
    expected_L_mu_negative[3][0] = -0.08750000 ; 
    expected_L_mu_negative[3][1] = 0.30000000 ; 
    expected_L_mu_negative[3][2] = -0.71250000 ; 
    ...
    std::cout << "Calculated mass matrix: \n" << matrix << std::endl;
