#=============================================================================
#
#    This is a copy of FindMPI.cmake from CMake version 2.8.11.2
#
#    It includes some minor modifications to enable use of openmpi
#    installed with MPI programs prefixed with "open" (e.g. mpicxx --> openmpicxx):
#
#-----------------------------------------------------------------------------
...
#            changed to:
#
#        set(_MPI_C_COMPILER_NAMES                  mpicc    mpcc      mpicc_r mpcc_r  openmpicc)
#-----------------------------------------------------------------------------
...
#                                                   mpif90   mpif90_r  mpf90   mpf90_r
#                                                   mpif77   mpif77_r  mpf77   mpf77_r
#                                                   openmpif95 openmpif90 openmpif77)
#-----------------------------------------------------------------------------
#        set(_MPI_EXEC_NAMES                        mpiexec mpirun lamexec srun)
#
#            changed to:
#
#        set(_MPI_EXEC_NAMES                        mpiexec mpirun openmpiexec openmpirun lamexec srun)
#-----------------------------------------------------------------------------
#
#=============================================================================
#    Copyright Jonathan Madsen 09-2013
#=============================================================================
...
set(_MPI_C_COMPILER_NAMES                  mpicc    mpcc      mpicc_r mpcc_r  openmpicc mpicc-mp)
set(_MPI_CXX_COMPILER_NAMES                mpicxx   mpiCC     mpcxx   mpCC    mpic++   mpc++
                                           mpicxx_r mpiCC_r   mpcxx_r mpCC_r  mpic++_r mpc++_r
                                           openmpicxx openmpic++ mpicxx-mp)
set(_MPI_Fortran_COMPILER_NAMES            mpif95   mpif95_r  mpf95   mpf95_r
                                           mpif90   mpif90_r  mpf90   mpf90_r
                                           mpif77   mpif77_r  mpf77   mpf77_r
                                           openmpif95 openmpif90 openmpif77
...
set(_MPI_EXEC_NAMES                        mpiexec mpirun 
                                           openmpiexec openmpirun
                                           mpiexec.hydra-mp mpiexec.gforker-mp
                                           lamexec srun)
