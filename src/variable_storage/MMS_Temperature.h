...
public:
  ...
  double get_mms_temperature(const double position , const double time) const;
  double get_mms_temperature_time_derivative(const double position , const double time) const;
private:    
