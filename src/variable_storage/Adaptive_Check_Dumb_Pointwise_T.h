#ifndef Adaptive_Check_Dumb_Pointwise_T_h
#define Adaptive_Check_Dumb_Pointwise_T_h


/** @file   Adaptive_Check_Dumb_Pointwise_T.h
  *   @author pmaginot
...
class Adaptive_Check_Dumb_Pointwise_T : public V_Adaptive_Check
{
public:
  Adaptive_Check_Dumb_Pointwise_T(
  ...
  virtual ~Adaptive_Check_Dumb_Pointwise_T(){}
