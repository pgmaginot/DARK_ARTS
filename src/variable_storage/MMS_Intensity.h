...
public:
  ...
  double get_mms_intensity(const double position , const double time , const int dir) const ;
  double get_mms_intensity(const double position , const double time , const double mu) const;

  double get_mms_phi(const double position , const double time ) const ;
  double get_mms_intensity_time_derivative(const double position , const double time , const int dir) const ;
  double get_mms_intensity_space_derivative(const double position , const double time , const int dir) const ;
private:  
