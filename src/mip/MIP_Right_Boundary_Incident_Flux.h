...
public:
  ...
  MIP_Right_Boundary_Incident_Flux(const Angular_Quadrature& angular_quadrature);
    
  virtual ~MIP_Right_Boundary_Incident_Flux(){}
    
  void add_right_boundary_contributions(Eigen::MatrixXd& cell_c, Eigen::MatrixXd& cell_cp1, Eigen::VectorXd& rhs) override;
