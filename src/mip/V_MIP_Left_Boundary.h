...
public:
  ...
  V_MIP_Left_Boundary(const Angular_Quadrature& angular_quadrature);
    
  virtual ~V_MIP_Left_Boundary(){}
    
  virtual void add_left_boundary_contributions(Eigen::MatrixXd& cell_c, Eigen::MatrixXd& cell_cp1, Eigen::VectorXd& rhs) = 0;
