...
/// IC_BC block
enum RADIATION_BC_TYPE{ VACUUM_BC, REFLECTIVE_BC, INCIDENT_BC, INVALID_RADIATION_BC_TYPE};

enum INCIDENT_BC_VALUE_TYPE{ INCIDENT_CURRENT , INCIDENT_INTENSITY, INVALID_INCIDENT_BC_VALUE_TYPE};
...
enum TEMPERATURE_IC_TYPE{ CONSTANT_TEMPERATURE_IC, INVALID_TEMPERATURE_IC_TYPE};
