...
enum ADAPTIVE_TIME_STEP_CONTROL { CHANGE_IN_T , NO_ADAPTIVE_CONTROL , INVALID_ADAPTIVE_TIME_STEP_CONTROL};
...
enum FIXED_SOURCE_TYPE { NO_SOURCE , MMS_SOURCE , CONSTANT_SOURCE , INVALID_FIXED_SOURCE_TYPE } ;
